...
package cc.algs.suffixtree;

import static cc.algs.suffixtree.Utils.getSubstrings;
import cc.algs.suffixtree.Edge;
import cc.algs.suffixtree.GeneralizedSuffixTree;
import cc.algs.suffixtree.Node;
...
public class SuffixTreeTest extends TestCase {
    ...
    public void testSampleAddition() {
        ...
        String[] words = new String[] {
            ...
            "acrossthetauntonriverfromdightonindightonrockstatepark", "dightonma", "dightonrock", "6mineoflowgaponlowgapfork", "lowgapky",
            "lemasterjohnjandellenhouse", "lemasterhouse", "70wilburblvd", "poughkeepsieny", "freerhouse", "701laurelst", "conwaysc",
            "hollidayjwjrhouse", "mainandappletonsts", "menomoneefallswi", "mainstreethistoricdistrict", "addressrestricted",
            "brownsmillsnj", "hanoverfurnace", "hanoverbogironfurnace", "sofsavannahatfergusonaveandbethesdard", "savannahga",
            "bethesdahomeforboys", "bethesda"
        };
        for (int i = 0; i < words.length; ++i) {
            in.put(words[i], i);
